...
export default function Windchills() {
    ...
    const windchillFeatures = [
        {
            ...
            content: "Manage data at scale with web architecture built for multi-system orchestration.",
            imageUrl: Cloud
        },
        {
            name: "Secure collaboration",
            content: "Work securely inside and outside the enterprise with IP- and platform-based protections.",
            imageUrl: Security
        },
        {
            name: "Streamlined Upgrades",
            content: "Reduce user disruption by upgrading data in place with time-saving automation.",
            imageUrl: Updates
        },
        {
            name: "Admin and Support",
            content: "Leverage IoT-based “always on” system monitoring and PTC's expert-driven learning programs.",
            imageUrl: Admin
        },
        {
            name: "Flexible Delivery",
            content: "Flexible delivery: Deliver on-premises or in the cloud for greater uptime and security compliance.",
            imageUrl: Delivery
        },
    ];
    ...
    const home_content = {
        ...
        content: "Realize value quickly with standardized, out-of-the-box functionality across a comprehensive portfolio of core PDM and advanced PLM applications.",
        logo: Logo,
        classHome: "windchill",
        back_img: 'https://res.cloudinary.com/dbomu1erj/image/upload/v1691050119/Images_Website/Windchill_bg_ltjias.jpg'
    }
    ...
    const features = [
        {
            ...
            content: "Windchill brings significant benefits to the product development lifecycle, including reduced costs, faster time to market, improved product quality, and enhanced collaboration. Its streamlined processes and data management optimize resources and maximize efficiency, leading to higher customer satisfaction and cost savings through minimized prototyping and increased data re-use. ",
            reversed: true,
            img: CreoImg
        },
    ]
    ...
    return (
        <div>
            ...
            <Value title={"Windchill elevates product development for all stakeholders, delivering rapid value."} values={values} id={"value_windchill"} />
            <Info features={features} id="benifits_windchill" />
            <OnShapeFeatures title="Framework & Deployment" className="features_windchill" features={windchillFeatures} id="framework_windchill" />
