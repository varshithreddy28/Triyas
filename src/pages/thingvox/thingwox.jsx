...
export default function Thingwox() {
  ...
  const windchillFeatures = [
    {
      ...
      content: "Scale to new markets, improve throughput, and unlock new business models such as products as a service.",
      imageUrl: Cloud
    },
    {
      name: "REVOLUTIONIZE",
      content: "Get to market faster using a rich set of industrial IoT capabilities. Wrap and extend existing assets within your connected solution.",
      imageUrl: Security
    },
    {
      name: "REDUCE COSTS",
      content: "Leverage data from connected products and systems to increase productivity, lower cost, and increase efficiency.",
      imageUrl: Updates
    },
    {
      name: "IMPROVE QUALITY",
      content: "Make product, service, and factory operations more secure and scalable. Improve service quality, reliability, and satisfaction.",
      imageUrl: Admin
    },
    {
      name: "MAXIMIZE FLEXIBILITY",
      content: "Take control of your deployment options with on-premise, cloud, or a hybrid approach. Flexibly support any industrial use case.",
      imageUrl: Delivery
    },
  ];
  ...
  const home_content = {
    ...
    content: "Embrace digital transformation effortlessly with ThingWorx, the purpose-built IIoT platform designed to tackle your business obstacles.",
    logo: Logo,
    classHome: "windchill",
    back_img: 'https://res.cloudinary.com/dbomu1erj/image/upload/v1691084381/Images_Website/s2kg55j1a7neexrrk6sg.png'
  }
  ...
  return (
    <div>
      ...
      <OnShapeFeatures title="Unlock the full potential of your IIoT capabilities" className="" features={windchillFeatures} id="framework_windchill" />
